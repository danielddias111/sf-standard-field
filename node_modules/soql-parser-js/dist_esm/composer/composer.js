...
export function formatQuery(soql, formatOptions) {
    return composeQuery(parseQuery(soql), { format: true, formatOptions: formatOptions });
}
export function composeQuery(soql, config) {
...
var Compose = (function () {
    function Compose(soql, config) {
        ...
        this.format = format;
        this.query = '';
        this.formatter = new Formatter(this.format, __assign({ logging: this.logging }, config.formatOptions));
